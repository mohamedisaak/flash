...
interface Row { id: number; question: string; answer: string; order: number; is_active: boolean; }
export default function FaqsPage() {
  return (
    <CrudSection<Row>
      title="FAQs" resourcePath="cms/faqs" queryKey="faqs"
      columns={[
      ...
      toForm={(r) => ({ question: r.question, answer: r.answer, order: r.order, is_active: r.is_active })}
    />
  );
}
